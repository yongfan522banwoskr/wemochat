// BIP39 前500个常用短单词 (3-6字母)
const WORDLIST = [
  'abandon', 'ability', 'able', 'about', 'above', 'absent', 'absorb', 'abstract', 'absurd', 'abuse',
  'academy', 'access', 'accident', 'account', 'accuse', 'achieve', 'acid', 'acoustic', 'acquire', 'across',
  'act', 'action', 'actor', 'actual', 'adapt', 'add', 'addict', 'address', 'adjust', 'admit',
  'adult', 'advance', 'advice', 'aerobic', 'affair', 'afford', 'afraid', 'again', 'age', 'agent',
  'agree', 'ahead', 'aim', 'air', 'aisle', 'alarm', 'album', 'alcohol', 'alert', 'alien',
...
/**
 * Generate n random mnemonic words from the wordlist
 * @param {number} count - Number of words (default 3)
 * @returns {string[]}
 */
function generateMnemonicWords(count = 3) {
  const words = [];
  const used = new Set();
...
/**
 * Validate that the given words are from our wordlist
 * @param {string[]} words
 * @returns {boolean}
 */
